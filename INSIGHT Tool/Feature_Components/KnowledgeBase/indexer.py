...
class RepositoryIndexer:
    ...
    def index_repository(self, repo_path: str, repo_name: str) -> IndexResult:
        ...
        window_metadata_path = self.index_dir / repo_name.replace('/', '_') / "windows_metadata.json"
    ...
    def get_index_status(self, repo_name: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            return {
                ...
                'index_path': str(index_path),
                'metadata_path': str(metadata_path),
                'window_index_path': str(window_index_path) if window_index_path.exists() else None,
